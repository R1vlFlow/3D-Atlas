...
## Beta 1.9
Ключевые кости получили структурированные учебные карточки: части, концы, тело, поверхности, отростки и анатомические ориентиры на русском и латинском.

### Beta 1.11
Интерактивные элементы костей доступны из карточки кости. Сопоставление с 3D-моделью выполняется только при наличии подходящего mesh; отсутствующие элементы не маскируются фиктивными координатами.
